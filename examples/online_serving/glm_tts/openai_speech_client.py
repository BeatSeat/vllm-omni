...
Supports text-only synthesis and voice cloning with ref_audio + ref_text.
...
Usage:
    ...
    python openai_speech_client.py --text "Hello world" --max-new-tokens 2048

    # Voice cloning
    python openai_speech_client.py --text "你好" --ref-audio ref.wav --ref-text "参考文本"

    # Specify output format
    python openai_speech_client.py --text "你好" --response-format mp3 -o output.mp3
"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Reference audio URL or file:// path for voice cloning",
    )
    parser.add_argument(
        "--ref-text",
        type=str,
