...
REFERENCE_PROMPT_WAV_PATH = test_asset_path("glm_tts/jiayan_zh.wav")
...
def _get_deploy_config(*, async_chunk: bool) -> str:
    """Build deploy config with explicit sync/async mode and conservative memory settings."""
...
def test_offline_voice_clone_zh(async_chunk: bool) -> None:
    ...
    """
    synth_text = "我捡到一只超可爱的流浪猫。我给它取了一个名字，叫丁满。"
