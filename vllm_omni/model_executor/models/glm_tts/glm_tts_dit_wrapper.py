    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        for idx, req_ids in enumerate(request_ids_list):
            ...
            stream_finished = as_bool(nested_get(info, "meta", "stream_finished")) if info else False
            ...
            uses_streaming = bool(info) and (
                has_meta or "stream_finished" in info or "token_offset" in info or "left_context_size" in info
            )
            ...
            if uses_streaming:
                ...
                chunk_sizes_history = as_int_list(nested_get(info, "meta", "chunk_sizes_history"))
                block_pattern = as_int_list(nested_get(info, "meta", "block_pattern"))
                crossfade_sec = as_float(nested_get(info, "meta", "crossfade_sec"), 0.1)
